<%@ Page Title="" Language="C#" MasterPageFile="Dashboard.master" AutoEventWireup="true" CodeFile="CrewData.aspx.cs" Inherits="CrewData" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <style>
        ...
        /*tbody tr:not(:first-child):hover:not(:last-child):hover{
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageTitle" runat="server">פרטי אנשי צוות</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="PageLinks" runat="server"><a href="Default.aspx">ראשי</a> » <a href="ControlPanel.aspx">פאנל ניהול</a> » אנשי צוות
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="card-panel" style="margin: 40px 0 0 0;">
        ...
        <asp:Panel ID="PnlShowCrew" runat="server">
            ...
            <asp:GridView ID="GVCrew" runat="server"  CellPadding="4" CssClass="gvCrew  table-striped-accordion" GridLines="None" BorderStyle="None" OnLoad="GVCrew_Load" OnRowDeleting="GVCrew_RowDeleting" AllowPaging="True" OnPageIndexChanging="GVCrew_PageIndexChanging" BackColor="White" OnPreRender="GVCrew_PreRender" OnRowCreated="GVCrew_RowCreated" OnRowDataBound="GVCrew_RowDataBound" PageSize="20">
            </asp:GridView>
            <br />
